<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = "";
		 $sWhere.=" WHERE nota_venta.id_cliente=clientes.id_cliente and nota_venta.id_vendedor=users.user_id";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class="text-right">
						<a href="editar_factura.php?id_nota_venta=<?php echo $id_nota_venta;?>" class='btn btn-default' title='Editar Nota de Venta' ><i class="glyphicon glyphicon-edit"></i></a> 
						...
						<a href="#" class='btn btn-default' title='Borrar Nota de Venta' onclick="eliminar_nota('<?php echo $numero_nota_venta; ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
					</td>
