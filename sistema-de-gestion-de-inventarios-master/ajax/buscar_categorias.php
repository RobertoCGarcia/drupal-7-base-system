<?php
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
			...
			$sWhere .= ') AND categorias.id_proveedor = proveedor.id_proveedor order by nombre_categoria';
		}else{
			$sWhere.=" WHERE categorias.id_proveedor = proveedor.id_proveedor order by nombre_categoria";
		}
		...
		//print " sql: SELECT count(*) AS numrows FROM " .  $sTable . $sWhere ."<br/>";
		...
		$sql="SELECT categorias.id_categoria,
		             categorias.id_proveedor, 
		             categorias.nombre_categoria, 
		             categorias.descripcion_categoria, 
		             categorias.date_added,
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class='text-right'>
						<a href="#" class='btn btn-default' title='Editar categoría' data-proveedor='<?php echo $proveedor;?>' data-idproveedor='<?php echo $id_proveedor;?>' data-nombre='<?php echo $nombre_categoria;?>' data-descripcion='<?php echo $descripcion_categoria?>' data-id='<?php echo $id_categoria;?>' data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a> 
