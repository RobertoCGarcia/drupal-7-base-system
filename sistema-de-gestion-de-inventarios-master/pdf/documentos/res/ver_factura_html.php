...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;" border="3">
        <tr>
...
?>
		...
		<tr>
            ...
            <td style="widtd: 15%; text-align: right;"> 
            	<?php echo number_format($total_factura,2) . "<br/>"; ?>
